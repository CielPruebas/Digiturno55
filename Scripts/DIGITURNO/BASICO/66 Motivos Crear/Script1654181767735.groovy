...
WebUI.setText(findTestObject('DIGITURNO/CONFIGURACION/6Elementos del Sistema/2 Motivos/Edicion/span_Motivos(1)/input_Nombre'), 
    'Prueba')
...
'Selecciona el tipo de ocio por el index para tomarlo en general'
WebUI.selectOptionByIndex(findTestObject('DIGITURNO/CONFIGURACION/6Elementos del Sistema/2 Motivos/Edicion/span_Motivos(1)/select_Tipo Ocio'), 
    0)

WebUI.delay(2)

WebUI.click(findTestObject('DIGITURNO/CONFIGURACION/6Elementos del Sistema/2 Motivos/Edicion/span_Motivos(1)/img_Nuevo'))
