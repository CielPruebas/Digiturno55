...
WebUI.setText(findTestObject('DIGITURNO/CONFIGURACION/7Sistema/4 Paginas/Lista de Paginas/input_TextoABuscar'), '31')

WebUI.delay(3)

WebUI.click(findTestObject('DIGITURNO/CONFIGURACION/7Sistema/4 Paginas/Lista de Paginas/img_Editar'), FailureHandling.STOP_ON_FAILURE)
