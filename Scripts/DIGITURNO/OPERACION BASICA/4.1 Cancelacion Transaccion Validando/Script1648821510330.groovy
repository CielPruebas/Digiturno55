...
WebUI.click(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/img_Cancelar Transaccion'))

WebUI.delay(3)

WebUI.click(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/img_Cancelar Transaccion(1)/btn_4Tramitador_16C'))

'validando'
WebUI.verifyElementVisible(findTestObject('DIGITURNO/OPERACION/2Terminales/Estados a Verificar/div_Cancelado'))
