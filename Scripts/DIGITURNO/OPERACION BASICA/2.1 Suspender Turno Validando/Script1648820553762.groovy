...
'verifica existencia del div llamando'
...
'verifica existencia del div ocupado'
...
WebUI.click(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/img_Suspender'))

WebUI.delay(3)

WebUI.click(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/img_Suspender(1)/btn_1FaltaAusente'))

WebUI.verifyElementVisible(findTestObject('DIGITURNO/OPERACION/2Terminales/Estados a Verificar/div_Suspendido'))
