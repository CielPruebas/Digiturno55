...
WebUI.click(findTestObject('DIGITURNO/CONFIGURACION/2Distribucion Geografica/4Grupos/Lista de Grupos/td_2Grupo PQRS'))

WebUI.delay(3)

WebUI.selectOptionByLabel(findTestObject('DIGITURNO/CONFIGURACION/2Distribucion Geografica/4Grupos/Edicion/select_Busqueda de turnos en la actual'), 
    'Grupo', false)
...
WebUI.click(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/img_Buscar Turno(1)/a_x'))
