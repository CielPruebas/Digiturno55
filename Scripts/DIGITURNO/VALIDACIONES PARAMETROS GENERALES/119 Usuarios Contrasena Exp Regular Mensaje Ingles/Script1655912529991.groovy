...
WebUI.setText(findTestObject('DIGITURNO/CONFIGURACION/7Sistema/1 Parametros Generales/input_Busqueda'), 'Usuarios.Contrasena.ExpRegular.Mensaje_en')
...
'cambiar idioma aplicacion'
WebUI.selectOptionByIndex(findTestObject('0Inicio Sesion/select_Idioma'), 1, FailureHandling.STOP_ON_FAILURE)

WebUI.delay(3)

WebUI.setText(findTestObject('0Inicio Sesion/input_Usuario'), 'ciel')

WebUI.setText(findTestObject('0Inicio Sesion/input_Clave'), 'digi')
