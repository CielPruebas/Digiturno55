...
WebUI.setText(findTestObject('DIGITURNO/CONFIGURACION/7Sistema/1 Parametros Generales/input_Busqueda'), 'Usuarios.Contrasena.ExpRegular.Mensaje_es')
...
WebUI.selectOptionByIndex(findTestObject('0Inicio Sesion/select_Idioma'), 0, FailureHandling.STOP_ON_FAILURE)
