...
WebUI.selectOptionByLabel(findTestObject('DIGITURNO/CONFIGURACION/2Distribucion Geografica/4Grupos/Edicion/select_Transferencia de turnos en la actual'), 
    'Sala', false)
...
WebUI.click(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/img_Tranferir(1)/span_Contraer y Expandir(2)'))
