...
'Sistema.Login.Intentos.Tiempo'
WebUI.setText(findTestObject('DIGITURNO/CONFIGURACION/7Sistema/1 Parametros Generales/input_Busqueda'), 'Sistema.Login.Intentos.Tiempo')
...
'Formato HH:MM:SS, para el ejemplo 00:00:10'
