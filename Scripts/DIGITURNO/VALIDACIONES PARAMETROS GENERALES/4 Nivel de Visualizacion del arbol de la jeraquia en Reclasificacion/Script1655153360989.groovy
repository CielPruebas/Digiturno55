...
WebUI.click(findTestObject('DIGITURNO/CONFIGURACION/0Principal/img_2Distribucion Geografica'))
...
'Grupo Información'
WebUI.click(findTestObject('DIGITURNO/CONFIGURACION/2Distribucion Geografica/4Grupos/Lista de Grupos/td_1Grupo Informacion'))

WebUI.scrollToPosition(10, 800)

WebUI.delay(3)

WebUI.selectOptionByLabel(findTestObject('DIGITURNO/CONFIGURACION/2Distribucion Geografica/4Grupos/Edicion/select_Nivel de visualizacion del arbol de jerar en reclasificacion'), 
    'Todos', false)
...
WebUI.click(findTestObject('DIGITURNO/CONFIGURACION/2Distribucion Geografica/4Grupos/Edicion/img_Actualizar'))
...
WebUI.click(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/img_Reclasificar'))
...
WebUI.selectOptionByIndex(findTestObject('DIGITURNO/CONFIGURACION/2Distribucion Geografica/4Grupos/Edicion/select_Nivel de visualizacion del arbol de jerar en reclasificacion'), 
