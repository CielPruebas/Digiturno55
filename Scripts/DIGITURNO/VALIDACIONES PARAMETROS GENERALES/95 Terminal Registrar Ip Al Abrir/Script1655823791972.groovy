...
'Terminal.RegistrarIpAlAbrir'
WebUI.setText(findTestObject('DIGITURNO/CONFIGURACION/7Sistema/1 Parametros Generales/input_Busqueda'), 'Terminal.RegistrarIpAlAbrir')
...
WebUI.click(findTestObject('DIGITURNO/CONFIGURACION/0Principal/img_6Elementos del sistema'))
