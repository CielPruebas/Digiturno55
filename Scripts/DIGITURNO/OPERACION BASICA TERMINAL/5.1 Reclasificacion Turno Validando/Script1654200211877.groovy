...
'Reclasificar el turno'
WebUI.delay(3)

WebUI.click(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/img_Reclasificar(1)/a_2PQRS - General'))

WebUI.delay(3)

WebUI.click(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/img_Reclasificar(1)/img_Reclasificar(1) (1)/img_Reclasificar(2) (1)/a_2Facturacion'))

'validando Reclasificar'
WebUI.verifyElementVisible(findTestObject('DIGITURNO/OPERACION/2Terminales/Estados a Verificar/div_Reclasificar'))
