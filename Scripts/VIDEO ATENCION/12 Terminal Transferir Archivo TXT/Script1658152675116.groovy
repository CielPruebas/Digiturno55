...
'cambiamos a terminal'
WebUI.switchToWindowIndex(1)

WebUI.delay(3)

WebUI.scrollToElement(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/input_Seleccionar Archivo'), 0)

WebUI.uploadFile(findTestObject('DIGITURNO/OPERACION/2Terminales/Terminal/input_Seleccionar Archivo'), 'C:\\CIEL INGENIERIA\\Katalon\\Digiturno55\\archivos\\1.txt')
