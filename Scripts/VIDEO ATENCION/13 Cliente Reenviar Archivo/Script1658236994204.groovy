...
WebUI.scrollToElement(findTestObject('VIDEO ATENCION/Cliente/Atencion/Archivos/img_Reenviar Archivo'), 2)

WebUI.click(findTestObject('VIDEO ATENCION/Cliente/Atencion/Archivos/img_Reenviar Archivo'))
