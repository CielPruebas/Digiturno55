...
WebUI.scrollToElement(findTestObject('VIDEO ATENCION/Cliente/Atencion/Archivos/img_Eliminar Archivo Enviado'), 2)

WebUI.click(findTestObject('VIDEO ATENCION/Cliente/Atencion/Archivos/img_Eliminar Archivo Enviado'))
