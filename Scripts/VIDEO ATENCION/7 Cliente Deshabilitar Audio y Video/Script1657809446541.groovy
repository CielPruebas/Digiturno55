...
'Deshabilitamos Microfono del Cliente'
WebUI.scrollToElement(findTestObject('VIDEO ATENCION/Cliente/Atencion/img_1CerrarMicrofono'), 3)

WebUI.click(findTestObject('VIDEO ATENCION/Cliente/Atencion/img_1CerrarMicrofono'))

WebUI.click(findTestObject('VIDEO ATENCION/Cliente/Atencion/img_1CerrarCamara'))

WebUI.delay(3)

WebUI.takeFullPageScreenshot()

'Volvemos a la terminal para cerrar la atención'
WebUI.switchToWindowIndex(1)
