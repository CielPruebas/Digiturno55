...
WebUI.click(findTestObject('VIDEO ATENCION/Terminal/img_1CerrarCamara'))

WebUI.click(findTestObject('VIDEO ATENCION/Terminal/img_1CerraMicrofono'))

WebUI.delay(3)

WebUI.takeFullPageScreenshot()

'Vamos a Video atencion'
