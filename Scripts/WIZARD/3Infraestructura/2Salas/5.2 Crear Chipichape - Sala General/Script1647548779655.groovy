...
'Se escoge oficina Cali para crear Chipichape - Sala General'
WebUI.click(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/btn_SeleccionarOficina'))

WebUI.delay(2)

WebUI.click(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/btn_Seleccionar Oficina(1)/a_Cali - Chipichape'))

WebUI.delay(2)

WebUI.setText(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/input_Nombre'), 'Chipichape - Sala General')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/textarea_Descripcion'), 'Chipichape - Sala General')
