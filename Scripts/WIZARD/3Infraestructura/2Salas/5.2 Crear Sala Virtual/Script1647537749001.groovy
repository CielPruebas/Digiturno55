...
'Se escoge oficina Virtual para crear Virtual - Sala General '
WebUI.click(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/btn_SeleccionarOficina'))

WebUI.delay(2)

WebUI.click(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/btn_Seleccionar Oficina(1)/a_Virtual - Oficina Virtual'))

WebUI.delay(2)

WebUI.setText(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/input_Nombre'), 'Virtual - Sala General')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/textarea_Descripcion'), 'Virtual - Sala General')
