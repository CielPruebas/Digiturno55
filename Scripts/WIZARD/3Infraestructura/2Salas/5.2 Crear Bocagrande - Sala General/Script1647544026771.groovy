...
'Se escoge oficina Cartagena para crear Bocagrande - Sala General'
WebUI.click(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/btn_SeleccionarOficina'))

WebUI.delay(2)

WebUI.click(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/btn_Seleccionar Oficina(1)/a_Cartagena - Bocagrande'))

WebUI.delay(2)

WebUI.setText(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/input_Nombre'), 'Bocagrande - Sala General')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/textarea_Descripcion'), 'Bocagrande - Sala General')
...
WebUI.scrollToElement(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/Label/label_Habilitar Agendamiento'), 3)
