...
'Se escoge oficina Manizales para crear Manizales - Sala General'
WebUI.click(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/btn_SeleccionarOficina'))

WebUI.delay(2)

WebUI.click(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/btn_Seleccionar Oficina(1)/a_Manizales - Manizales'))

WebUI.delay(2)

WebUI.setText(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/input_Nombre'), 'Manizales - Sala General')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/textarea_Descripcion'), 'Manizales - Sala General')
