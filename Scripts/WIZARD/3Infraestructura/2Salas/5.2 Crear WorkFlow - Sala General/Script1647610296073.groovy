...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/input_Nombre'), 'WorkFlow - Sala General')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/2Salas/2Edicion/textarea_Descripcion'), 'WorkFlow - Sala General')
