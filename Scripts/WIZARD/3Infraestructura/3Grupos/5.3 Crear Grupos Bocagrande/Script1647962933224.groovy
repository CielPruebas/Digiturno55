...
'Se escoge sala Bocagrande - Sala General'
WebUI.click(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/btn_Sala'))

WebUI.delay(3)

WebUI.click(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/btn_Sala(1)/a_3Bocagrande - Sala General'))

WebUI.delay(3)

WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/input_Nombre'), 'Grupo Información')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/textarea_Descripcion'), 'Bocagrande - Grupo Información')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/textarea_Descripcion'), 'Bocagrande - PQRS')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/textarea_Descripcion'), 'Bocagrande - Radicaciones')
