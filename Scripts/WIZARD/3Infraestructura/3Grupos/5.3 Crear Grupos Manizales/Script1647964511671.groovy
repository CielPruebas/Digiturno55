...
'Se escoge sala Manizales - Sala General'
WebUI.click(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/btn_Sala'))

WebUI.delay(3)

WebUI.click(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/btn_Sala(1)/a_4Manizales - Sala General'))

WebUI.delay(3)

WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/input_Nombre'), 'Grupo Información')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/textarea_Descripcion'), 'Manizales - Grupo Información')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/textarea_Descripcion'), 'Manizales - PQRS')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/textarea_Descripcion'), 'Manizales - Radicaciones')
