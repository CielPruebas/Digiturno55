...
'Se escoge sala Virtual - Sala General'
WebUI.click(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/btn_Sala'))

WebUI.delay(3)

WebUI.click(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/btn_Sala(1)/a_6Virtual - Sala General'))

WebUI.delay(3)

WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/input_Nombre'), 'Grupo Información')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/textarea_Descripcion'), 'Virtual - Grupo Información')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/textarea_Descripcion'), 'Virtual - PQRS')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/3Grupos/Edicion/textarea_Descripcion'), 'Virtual - Radicaciones')
