...
'inicio Cartagena informacion'
WebUI.click(findTestObject('WIZARD/3Infraestructura/0Menu/span_Terminales'))

WebUI.delay(3)

WebUI.click(findTestObject('WIZARD/3Infraestructura/5Terminales/0OficinasModal/td_3Cartagena - Bocagrande'))
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/textarea_Descripcion'), 'Cartagena - Terminal - Informacion')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/textarea_Descripcion'), 'Cartagena - Terminal - PQRS')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/textarea_Descripcion'), 'Cartagena - Terminal - Radicaciones')
