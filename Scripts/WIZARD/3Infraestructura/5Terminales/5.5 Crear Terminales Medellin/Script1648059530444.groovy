...
'inicio Medellin informacion'
WebUI.click(findTestObject('WIZARD/3Infraestructura/0Menu/span_Terminales'))

WebUI.delay(3)

WebUI.click(findTestObject('WIZARD/3Infraestructura/5Terminales/0OficinasModal/td_5Medellin - Laureles'))
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/textarea_Descripcion'), 'Medellin - Terminal - Informacion')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/textarea_Descripcion'), 'Medellin - Terminal - PQRS')
...
WebUI.scrollToElement(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/input_Nombre'), 0)

WebUI.setText(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/input_Nombre'), 'A03')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/textarea_Descripcion'), 'Medellin - Terminal - Radicaciones')

'Para colocar Direccion en sala 3'
WebUI.scrollToElement(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/Label/label_Mostrar ventana emergente'), 
    2)
