...
'inicio Bogota Ciel Informacion'
WebUI.click(findTestObject('WIZARD/3Infraestructura/0Menu/span_Terminales'))

WebUI.delay(3)

WebUI.click(findTestObject('WIZARD/3Infraestructura/5Terminales/0OficinasModal/td_1Bogota - CIEL'))
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/textarea_Descripcion'), 'Bogota - Terminal - Informacion')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/textarea_Descripcion'), 'Bogota - Terminal - PQRS')
...
'inicio Bogota Ciel Radicaciones'
WebUI.click(findTestObject('WIZARD/3Infraestructura/0Menu/span_Terminales'))
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/5Terminales/Edicion/textarea_Descripcion'), 'Bogota - Terminal - Radicaciones')
