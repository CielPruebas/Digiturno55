...
WebUI.selectOptionByLabel(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/select_Departamento'), 'Cundinamarca', 
    false)

WebUI.delay(2)

WebUI.selectOptionByLabel(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/select_Ciudad'), 'Bogota', 
    false)

WebUI.delay(2)

'Oficina Bogota - CIEL'
WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/input_Nombre'), 'Bogota - CIEL')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/App/input_Nombre a mostrar'), 'Bogotá - CIEL')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/App/input_Direccion'), 'Calle 36 No 24-38')
