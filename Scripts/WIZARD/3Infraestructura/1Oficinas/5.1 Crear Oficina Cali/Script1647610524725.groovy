...
WebUI.selectOptionByLabel(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/select_Departamento'), 'Valle del Cauca', 
    false)

WebUI.delay(2)

WebUI.selectOptionByLabel(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/select_Ciudad'), 'Cali', false)

WebUI.delay(2)

'Oficina Cali - Chipichape'
WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/input_Nombre'), 'Cali - Chipichape')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/App/input_Nombre a mostrar'), 'Cali - Chipichape')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/App/input_Direccion'), 'Calle 3 No 24-3')
