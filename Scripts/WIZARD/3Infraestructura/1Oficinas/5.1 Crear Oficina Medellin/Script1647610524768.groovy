...
WebUI.selectOptionByLabel(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/select_Departamento'), 'Antioquia', 
    false)

WebUI.delay(2)

WebUI.selectOptionByLabel(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/select_Ciudad'), 'Medellin', 
    false)

WebUI.delay(2)

'Oficina Medellin - Laureles'
WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/input_Nombre'), 'Medellin - Laureles')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/App/input_Nombre a mostrar'), 'Medellin - Laureles')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/App/input_Direccion'), 'Calle 10 No 24-3')
