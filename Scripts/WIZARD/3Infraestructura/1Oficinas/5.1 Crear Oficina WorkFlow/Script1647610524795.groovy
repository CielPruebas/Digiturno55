...
WebUI.selectOptionByLabel(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/select_Departamento'), 'Dpto WorkFlow', 
    false)

WebUI.delay(2)

WebUI.selectOptionByLabel(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/select_Ciudad'), 'WorkFlow', 
    false)

WebUI.delay(2)

'Oficina WorkFlow - Oficina WorkFlow'
WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/Edicion/input_Nombre'), 'WorkFlow - Oficina WorkFlow')
...
WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/App/input_Nombre a mostrar'), 'WorkFlow - Oficina WorkFlow')

WebUI.setText(findTestObject('WIZARD/3Infraestructura/1Oficinas/2Edicion/App/input_Direccion'), 'Calle 24 No 21-33')
